...
package GlobalMusicApp.Controller;

import java.net.URL;
import java.util.ResourceBundle;

import GlobalMusicApp.Model.ConnectionClass;
...
public class Application implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) {
        if (event.getSource() == btn_Account) {
            try{
                ...
                String sql= "INSERT INTO `user` (`firstName`, `lastName`, `Address`, `Postcode`) VALUES ('test2', 'test2', 'testlastname2', 'testaddress2')";
    ...
    public void Confirm_MakeBooking (ActionEvent event){
        btn_MB_Confirm.setOnAction(e -> AlertBox.display("Pay Now","Enter the Details"));
